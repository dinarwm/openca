                      ...
                      <thead>
                        ...
                        <tbody>
                            ...
                            <td class="col-md-1 text-center">
                                <?php if ($row['RevokeC'] == "0"){
                                    ?>
                                    <form action="<?php echo base_url(); ?>Admin/revoke" method="POST" class="form-horizontal">
                                        <input class="form-control" name="id" type="hidden" value="<?php echo $row['ID_certificate']; ?>">
